...
class InnerHomeFifth : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView= inflater.inflate(R.layout.fragment_innter_home_fifth, container, false)
        ...
        recyclerView=rootView.findViewById(R.id.home_fifth)
        ...
        viewModel!!.getFifthTimeLine(recyclerView!!, adapter!!)
