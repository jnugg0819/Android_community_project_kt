...
import kotlinx.android.synthetic.main.fragment_innter_home_third.*


class InnerHomeThird : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView=inflater.inflate(R.layout.fragment_innter_home_third, container, false)
        ...
        recyclerView=rootView.findViewById(R.id.home_third)
        ...
        viewModel!!.getThirdTimeLine(recyclerView!!, adapter!!)
