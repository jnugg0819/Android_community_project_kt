...
class InnerHomeSecond : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView= inflater.inflate(R.layout.fragment_innter_home_second, container, false)
        ...
        recyclerView=rootView.findViewById(R.id.home_second)
        val layoutManager = GridLayoutManager(activity, 1)
        recyclerView!!.layoutManager=layoutManager

        viewModel!!.getSecondTimeLine(recyclerView!!,adapter!!)
